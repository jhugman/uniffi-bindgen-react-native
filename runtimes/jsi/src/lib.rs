...
pub use c_api::{
    ...
    ubrn_jsi_remember_trampoline, ubrn_jsi_rustbuffer_alloc, ubrn_jsi_rustbuffer_free,
    ubrn_jsi_rustbuffer_from_bytes, ubrn_jsi_scalar_slot_size_align, ubrn_jsi_struct_field_offsets,
    ubrn_jsi_trampoline_for, UbrnCallbackSpec, UbrnFunctionSpec, UbrnJsiModule, UbrnModuleSpec,
