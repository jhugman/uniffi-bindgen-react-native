...
#[uniffi::export]
pub fn use_calculator_strings(calc: Box<dyn Calculator>, a: String, b: String) -> String {
...
#[uniffi::export]
pub async fn use_async_fetcher(fetcher: std::sync::Arc<dyn AsyncFetcher>, input: String) -> String {
