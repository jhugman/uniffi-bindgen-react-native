...
// Tag factories for the `DEFINITIONS` table. Players read `.tag`, plus `.name`
// for Callback/Struct and `.inner` for Reference/MutReference; `.inner`
// mirrors the napi parser (`runtimes/napi/src/register/spec_from_js.rs`).
